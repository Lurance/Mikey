        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield axios_1.default.get(`https://api.weixin.qq.com/sns/jscode2session?appid=${wechat_config_1.wechatConfig.appid}&secret=${wechat_config_1.wechatConfig.appsecret}&js_code=${code}&grant_type=authorization_code`)
                ...
                if ('openid' in res.data) {
                    const user = yield user_service_1.UserService.getUserFromOrCreate({ usertype: 2, openid: res.data.openid });
                    ctx.body = {
                        jwt: yield user_service_1.UserService.genJWToken(user),
...
class UserAdminController {
    static login(ctx) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            ctx.body = {
                jwt: yield user_service_1.UserService.authUser(username, password, 1),
                username: username,
                usertype: 1
            };
        });
